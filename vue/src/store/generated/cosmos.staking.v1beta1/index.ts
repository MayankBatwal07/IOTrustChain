import { Client, registry, MissingWalletError } from 'IOTrustChain-client-ts'

import { StakeAuthorization } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { StakeAuthorization_Validators } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { LastValidatorPower } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { HistoricalInfo } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { CommissionRates } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { Commission } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { Description } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { Validator } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { ValAddresses } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { DVPair } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { DVPairs } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { DVVTriplet } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { DVVTriplets } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { Delegation } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { UnbondingDelegation } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { UnbondingDelegationEntry } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationEntry } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { Redelegation } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { Params } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { DelegationResponse } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationEntryResponse } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationResponse } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
import { Pool } from "IOTrustChain-client-ts/cosmos.staking.v1beta1/types"
